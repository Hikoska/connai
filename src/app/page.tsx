...
const FinalCTA = () => (
  <section className="py-16 bg-[#0D5C63] text-white">
    <div className="max-w-3xl mx-auto px-6 text-center">
      ...
      <StartInterviewButton className="bg-teal-500 hover:bg-teal-400 text-white font-bold py-4 px-10 rounded-full text-lg transition-colors shadow-lg shadow-teal-900/20"eal-900/30">
