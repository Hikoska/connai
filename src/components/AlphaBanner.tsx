...
export const AlphaBanner = () => {
  ...
  return (
    <div className="bg-amber-500 text-amber-900 text-sm text-center px-10 py-2 relative min-h-[36px] flex items-center justify-center">
      ...
      <button type="button"
      onClick={handleDismiss} className="absolute right-3 top-1/2 -translate-y-1/2 p-1 font-bold text-lg leading-none hover:oropacity-70 transition-opacity" aria-label="Dismiss banner">
        &times;
      </button>
    </div>
  )
